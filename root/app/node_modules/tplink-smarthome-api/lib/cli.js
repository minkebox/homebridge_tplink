...
function search(sysInfo, breakoutChildren, discoveryTimeout, params) {
    try {
...
commander_1.default
    ...
    search(options.sysinfo, options.breakoutChildren || false, commander_1.default.timeout, paramsObj);
});
commander_1.default
