...
class Plug extends device_1.default {
    ...
    async getInfo(sendOptions) {
        ...
        let data;
        try {
            data = await this.sendCommand('{"emeter":{"get_realtime":{}},"schedule":{"get_next_action":{}},"system":{"get_sysinfo":{}},"cnCloud":{"get_info":{}}}', __classPrivateFieldGet(this, _childId), sendOptions);
        }
        catch (err) {
